...
def generate_syllabus(payload: GenerateSyllabusRequest, current_user: User = Depends(get_current_user)):
    return syllabus_controller.generate_syllabus(current_user, payload)
