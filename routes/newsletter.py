...
def send_chapter_email(payload: SendChapterEmailRequest, current_user: User = Depends(get_current_user)):
    return newsletter_controller.send_chapter_email(current_user, payload)
