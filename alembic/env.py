...
if config.config_file_name is not None:
    # disable_existing_loggers defaults to True, which would DISABLE every logger
    # created before startup migrations run (Alembic runs in-process via
    # command.upgrade). That silently dropped all app logs — notably onboarding /
    # knowledge, whose modules are imported at startup. Keep them enabled.
