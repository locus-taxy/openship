def system_prompt() -> str:
    ...
    return (
        ...
        "- In mermaid diagram content: NEVER use parentheses (), commas, quotes, or angle brackets <> inside labels or message text — they break the mermaid parser. Use plain words only (e.g. 'verifyCredentials username password' not 'verifyCredentials(username, password)').\n"
